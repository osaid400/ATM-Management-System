...
def run_atm_menu(manager, account):
    while True:
        print("\n" + "=" * 60)
        ...
        if choice == "1":
            ...
            try:
                ...
                r_path = manager.generate_receipt(account, "Deposit", amt, "Cash Deposit")
            ...
            try:
                ...
                manager.save_accounts()
                r_path = manager.generate_receipt(account, "Withdrawal", amt, "Cash Withdrawal")
        ...
        if choice == "1":
            try:
                ...
                if acc and acc.verify_pin(pin):
                    ...
                    run_atm_menu(manager, acc)
                else:
                    print("Invalid Account Number or PIN.")
            except ValueError:
                print("Invalid input format.")
        elif choice == "0":
            print("Thank you for using our ATM Application. Good Bye!")
            sys.exit()
        else:
            print("Invalid Choice!")